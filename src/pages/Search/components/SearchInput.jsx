  ...
  return (
    <div className='bg-[#FFF] py-[20px] relative'>
      <div className="px-[20px] max-w-[1600px] mx-auto max-md:pr-[50px]">
       ...
       <input className='border border-[#EEEEEE] p-[16px] rounded-[32px] w-[36%] max-lg:w-[70%]' placeholder='Search' type="search" />
       <button className='btn-pri ml-[16px] max-md:ml-[6px]'>Search</button>
       </div>
      </div>
      <button className=' absolute right-[40px] top-[35%] cursor-pointer max-lg:right-[20px]'>
